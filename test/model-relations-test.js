            ...
            return Users.create(new_user)
                ...
                .then(users => {
                    ...
                    let project = users
                        .first()
                        .get('projects')
                        .find(p => p.get('name') == new_projects.first().get('name'));
...
test('It can save an object that has has_many relations on it and one of them also has a has_many relation on it', t => {
    ...
    return Helpers.setupDatabase([
        ...
        .then(user => {
            ...
            return Projects.include('lists')
                .reload(project_with_lists)
                .then(project => {
    ...
    return Helpers.setupDatabase([['users', 'name:string'], ['projects', 'name:string', 'user_id:uuid']])
        ...
        .then(project => {
            ...
            return Projects.save(project).then(project => {
                ...
                return Users.where({ name: initial_user.get('name') })
                    .include('projects')
                    .first()
                    .then(initial_user => {
                        ...
                        return Projects.save(project).then(project => {
                            return Users.where({ name: replacement_user.get('name') })
                                .include('projects')
                                .first()
                                .then(replacement_user => {
                                    ...
                                    return Users.include('projects')
                                        .find(initial_user.get('id'))
                                        .then(initial_user => {
