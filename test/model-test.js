...
test('It can build independent queries', t => {
    ...
    const paging = Users.where({ name: 'Test' })
        .page(3, 20)
        .toString();
...
test.serial('It can create a new instance', t => {
    ...
    return Helpers.setupDatabase([['list', 'name:string', 'tasks:jsonb']]).then(() => {
...
test.serial('It can save/restore/destroy an instance', t => {
    ...
    return Helpers.setupDatabase([['list', 'name:string', 'tasks:jsonb']])
        .then(() => {
...
test.serial('It can create instances with defaults', t => {
    ...
    return Helpers.setupDatabase([['list', 'name:string', 'tasks:jsonb', 'tasks_count:integer']])
        .then(() => {
            return Lists.create(new_list);
        })
        .then(list => {
...
test('It can use alternative timestamps', t => {
    ...
    return Helpers.setupDatabase([['users', 'name:string']], {
